          ...
          >
            ...
            <div className="bg-gradient-to-r from-amber-600 via-amber-500 to-amber-600 px-6 py-3 flex items-center justify-between text-slate-950 font-bold">
              <div className="flex items-center space-x-2 text-sm md:text-base">
                ...
                <span>FREE ON-SITE ASSESSMENT & FIXED QUOTE</span>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="p-6 md:p-8">
              {!submitted ? (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <label className="block text-xs font-medium text-slate-300 mb-1">Notes / Specific Requirements (Optional)</label>
                    <textarea
                      rows={2}
                      placeholder="Mention any specific leak areas, profile preference (Box, Quad, Half Round) or questions..."
                      value={notes}
                  ...
                  <div className="flex items-center justify-between pt-2">
                    ...
                    >
                      <span>{loading ? "Submitting..." : "REQUEST FREE QUOTE"}</span>
                ...
                <div className="text-center py-8 space-y-5">
                  ...
                  <p className="text-slate-300 max-w-md mx-auto text-sm">
                    Thank you <strong className="text-amber-400">{name}</strong>. One of our Canterbury guttering & roofing specialists will contact you at <strong className="text-amber-400">{phone}</strong> shortly to arrange your free on-site assessment.
                  </p>
                  <div className="bg-slate-900/80 border border-slate-700 rounded-xl p-4 max-w-md mx-auto text-left text-xs space-y-1 text-slate-300">
                    ...
                    <div>• <span className="font-semibold text-white">Guarantees:</span> 10-Yr Leak-Free / 15-Yr Colorsteel / 30-Yr Roof Replacement</div>
                  </div>
